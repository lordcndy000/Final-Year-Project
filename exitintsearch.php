...
$output = '';
$sql = "SELECT * FROM grad_exit_interview WHERE studentNo  LIKE '%".$_POST["search"]."%'or gender LIKE '%".$_POST["search"]."%'  or lastn LIKE '%".$_POST["search"]."%'or fname LIKE '%".$_POST["search"]."%'or mi LIKE '%".$_POST["search"]."%'or date_grad LIKE '%".$_POST["search"]."%'or sy_attended LIKE '%".$_POST["search"]."%'or program LIKE '%".$_POST["search"]."%'or comp_conn LIKE '%".$_POST["search"]."%'or job_title LIKE '%".$_POST["search"]."%'or ojt_host LIKE '%".$_POST["search"]."%'or dept_ass LIKE '%".$_POST["search"]."%'";
