<?php
   include('session.php');
   include('changegradpic.php');
   include('changegradpass.php');
?>
<!-- <li> <a href="jobplacement_assistance.php"> Job Placement Assistance Form  </a> </li>
<li> <a href="exit_interview.php"> Exit Interview  </a> </li> -->
<!DOCTYPE html>
<html class="no-js">
  <head>
    <meta content="text/html; charset=utf-8" http-equiv="Content-Type">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>STI Novaliches Graduating Page</title>
    <link rel="stylesheet" href="assets/css/grad/styles.css">
      ...
      <div id="graddashboard">
        <div id="gradbanner">
          ...
          <div id="hugename">
            ...
            <?php echo "<p id='hugencont'>$gradstudFname $gradstudLname </p>"; ?>
      ...
      <div id="alumprofile">
        <div id="alumpbanner">
          <div id="whatpdash">
            ...
            <?php echo "<p> $gradstudLname $gradstudMi $gradstudFname | $gradstudMail | $gradprog | Graduating </p>";  ?>
            </div>
          ...
          <div class="prof-cont">
            ...
            <div id="mydets">
              <div id="prof-img-cont">
                <form method='post' enctype="multipart/form-data" method="post" id='changepicform'>
                  <?php
                    $qry2 = "select grad_pic from grad_tbl where studentNo = $studNo";
                    $resul2 = mysqli_query($db_conx, $qry2);

                    while($row = mysqli_fetch_array($resul2))
                    {

                      echo "<img class='imgother' src='data:image;base64,".$row['grad_pic']."' height='250px' width='250px'>";
                  ...
                  <input type='submit' name='changepicgrad' id='changepicgrad' class='changepicalum' value='Save'>
                  <p id='changepassalumtog'>Change password ▼ </p>
                </form>

                <form id='formhide' method='post'>
                  <input type='password' name='gradpass1' id='gradpass1' placeholder='Type new password' required>
                  <input type='password' name='gradpass2' id='gradpass2' onkeyup="checkPass(); return false;" placeholder='Confirm new password'  required>
                   <span id="confirmMessage" class="confirmMessage"></span>
                  <input type='submit' name='changepassgrad' id='changepassgrad' class='changepicalum' value='Submit'>
            ...
            <div id="myformal">
              ...
              <div id="jobplacement_assistance" class='wrap'>
                <div id="logograd"></div>
                  <p>Job Placement Assistance Form</p>

              </div>

              <div id="exitint" class='wrap'>
                <div id="logograd"></div>
                  <p>Exit Interview</p>
...
<!--
  ...
  <script src="assets/js/gradfuncs.js"></script>
  </body>
</html>
